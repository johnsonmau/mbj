      ...
      roles: [
        {
          ...
          bullets: [
            "Build and maintain Java/Spring Boot backend services for MyHealtheVet, the VA's primary health portal serving millions of Veterans.",
            "Led Java and library upgrades across backend services: dependency compatibility, security patch compliance, long-term maintainability.",
            "Instrumented backend services with Grafana metrics, enabling data-driven performance monitoring in production.",
            "Expanded unit and integration test suites across critical Veteran-facing workflows in a federally regulated codebase.",
          ],
        },
      ],
    },
